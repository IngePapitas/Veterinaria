...
@section('Panza')
<form action="{{ route('Personal.update', $personal->id) }}" method="POST" class="flex mt-4 overflow-hidden" enctype="multipart/form-data">
    @csrf
    ...
    <div class="w-1/4 h-screen bg-gray-200">
        <div class="w-full bg-blue-300 flex items-center justify-center" id="avatar-container" style="padding-bottom: 100%;">
            <button id="eliminarImagenBtn" type="button" class="{{ $personal->imagen_path ? '' : 'hidden' }} bg-red-500 text-white font-semibold py-1 px-2 rounded">
                Eliminar Imagen
            </button>
        </div>
    ...
    <div class="w-3/4 h-screen bg-blue-200 p-16">
        <div class="mb-4">
            ...
            <input type="text" name="ci" id="ci" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $personal->ci }}" required>
        </div>

        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Nombre:</label>
            <input type="text" name="nombre" id="nombre" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $personal->nombre }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="mt-2">
                <label class="inline-flex items-center">
                    <input type="radio" name="sexo" value="Hombre" class="form-radio" {{ $personal->sexo === 'Hombre' ? 'checked' : '' }} required>
                    <span class="ml-2">Hombre</span>
                </label>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" name="sexo" value="Mujer" class="form-radio" {{ $personal->sexo === 'Mujer' ? 'checked' : '' }} required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="telefono" id="telefono" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $personal->telefono }}" required>
        </div>

        <div class="mb-4">
            <label for="sueldo" class="block text-gray-700 text-sm font-bold mb-2">Sueldo:</label>
            <input type="number" name="sueldo" id="sueldo" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $personal->sueldo }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="mr-4 flex items-center relative">
                <input type="text" name="especialidad" id="especialidad" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $personal->especialidad->descripcion }}" required>
