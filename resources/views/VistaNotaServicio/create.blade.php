            ...
            <div class="w-1/2 h-auto p-4">
                <div class="mb-4">
                    ...
                    <div class="flex items-center relative">
                        ...
                        <input type="text" name="servicioInput" id="servicioInput" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            ...
            <div class="w-1/2 h-auto p-4 ">
                <div class="mb-4">
                    ...
                    <div class="flex items-center relative">
                        ...
                        <input type="text" name="medicamentoInput" id="medicamentoInput" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        ...
        document.addEventListener('DOMContentLoaded', () => {
                ...
                if (pacienteencontrado) {
                    ...
                    if (pacienteencontrado.imagen_path) {
                        ...
                        if (imagenPath != "/storage/") {
                            ...
                            imagenCargada = true;
                            eliminarImagenBtn.classList.remove('hidden');
                            imagenCargadaInput.value = imagenPath;
                        }
                    } else {
                        actualizarAvatar();
                    }
            ...
            function actualizarTablaDeMedicamentos() {
                ...
                medicamentosSeleccionados.forEach(medicamentoValue => {
                    ...
                    const indice = cantidadesSeleccionadas.indexOf(medicamentoValue);
                    const cantidadCell = document.createElement('td');
                    cantidadCell.textContent = servicioEncontrado.precio + "Bs.";
