...
@section('Panza')
<form action="{{ route('Medicamento.store') }}" method="POST" class="flex mt-4 overflow-hidden" enctype="multipart/form-data">
    @csrf
    
    <div class="w-3/4 h-auto bg-blue-200 p-8">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold mb-8">Agregar Medicamento</h2>
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="descripcion" id="descripcion" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>

                <div class="mb-4">
                    <label for="forma_farmaceutica" class="block text-gray-700 text-sm font-bold mb-2">Forma Farmacéutica:</label>
                    <input type="text" name="forma_farmaceutica" id="forma_farmaceutica" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>

                <div class="mb-4">
                    <label for="dosis" class="block text-gray-700 text-sm font-bold mb-2">Dosis:</label>
                    <input type="text" name="dosis" id="dosis" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>

                <div class="mb-4">
                    <label for="precio" class="block text-gray-700 text-sm font-bold mb-2">Precio:</label>
                    <input type="number" name="precio" id="precio" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>

                <div class="mb-4">
                    <label for="stock" class="block text-gray-700 text-sm font-bold mb-2">Stock:</label>
                    <input type="number" name="stock" id="stock" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="mr-4 flex items-center relative">
                        <input type="text" name="laboratorio" id="laboratorio" class="w-full border rounded-lg py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
