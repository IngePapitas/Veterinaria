...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-4">
        <a href="{{ route('Paciente.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
            Registrar Paciente
        </a>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function cargarTabla(texto, orden) {
            fetch(`/buscar-paciente?texto=${texto}&ordenar=${orden}`)
